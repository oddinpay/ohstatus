<script lang="ts">
  ...
  import NotAlerts from "$lib/components/NotAlerts.svelte";
...
>
  <div class="fixed mx-auto w-full max-w-7xl py-4">
    ...
    >
      ...
      <div
        class="grid w-full grid-cols-1 gap-4 overflow-y-auto px-5 sm:px-10 pb-20 900:grid-cols-2"
      >
        <div
